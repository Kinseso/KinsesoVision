...
export default function Dashboard() {
  const sectors = [
    ...
    { name: "Cloud Recording", icon: Icons.Cloud, href: "/cloud", color: "text-blue-400", desc: "Secure Media Storage" },

    { name: "Creators Community", icon: Icons.Users, href: "/creator", color: "text-purple-500", desc: "Creator Network" },

    { name: "Marketplace", icon: Icons.Store, href: "/marketplace", color: "text-orange-500", desc: "Digital Commerce" },

    { name: "Messaging", icon: Icons.MessageCircle, href: "/chat", color: "text-cyan-500", desc: "Real-time Communication" },

    { name: "Community Feed", icon: Icons.Globe, href: "/feed", color: "text-blue-500", desc: "Social Activity Stream" },
    ...
    { name: "Evidence Vault", icon: Icons.ShieldCheck, href: "/vault", color: "text-blue-400", desc: "Secure Storage" },
    ...
    <div className="space-y-12">
      ...
      <header>
        ...
        <p className="text-zinc-500 text-xs font-bold uppercase tracking-[0.4em] mt-2">
          Kinseso Multi-Sector OS v2.026
        </p>
      </header>
