        ...
        <div className="flex min-h-screen">
          ...
          <nav className="w-72 bg-zinc-950/90 backdrop-blur-2xl p-6 border-r border-white/5 hidden md:flex flex-col fixed h-full z-50">
            <div className="mb-10 px-2 flex items-center justify-between">
              ...
              <Icons.Bell size={18} className="text-zinc-500 hover:text-white transition-colors cursor-pointer" />
            </div>

            {/* ACTION CENTER */}
            <div className="mb-8 flex gap-2">
              <Link href="/register" className="flex-1 bg-white text-black text-[10px] font-black uppercase py-3 rounded-xl text-center hover:bg-blue-600 hover:text-white transition-all">
                Sign In
              </Link>
            ...
            <div className="flex-1 space-y-1 overflow-y-auto pr-2 custom-scrollbar">
              ...
              <Link href="/feed" className="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-white/5 hover:text-blue-400 transition-all font-bold text-sm">
                <Icons.Globe size={18} /> Social Community
              </Link>
              <Link href="/blog" className="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-white/5 hover:text-amber-400 transition-all font-bold text-sm">
                <Icons.Newspaper size={18} /> News & Blog
              </Link>
              ...
              <Link href="/health" className="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-white/5 hover:text-emerald-400 transition-all font-bold text-sm">
                <Icons.Activity size={18} /> Health Hub
              </Link>
              <Link href="/beauty" className="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-white/5 hover:text-pink-400 transition-all font-bold text-sm">
                <Icons.Scissors size={18} /> Beauty Hub
              </Link>
              <Link href="/map" className="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-white/5 hover:text-blue-500 transition-all font-bold text-sm">
                <Icons.Navigation size={18} /> Logistics Map
              </Link>
              ...
              <div className="flex items-center gap-3 p-3 bg-zinc-900/40 rounded-2xl border border-white/5">
                ...
                <div className="flex flex-col leading-none">
                  ...
                  <span className="text-[8px] font-bold text-emerald-500 uppercase tracking-widest mt-1 flex items-center gap-1">
                    <Icons.ShieldCheck size={8} /> Live Vision OS
                  </span>
                </div>
              </div>
            </div>
          ...
          <main className="flex-1 md:ml-72 bg-slate-950 relative min-h-screen">
             ...
             <div className="p-10 pb-24 relative z-10">
               {children}
             </div>
          </main>
        </div>
