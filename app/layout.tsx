        ...
        <div className="flex min-h-screen">
          ...
          <nav className="w-72 bg-zinc-950/90 backdrop-blur-2xl p-6 border-r border-white/5 hidden md:flex flex-col fixed h-full z-50">
            <div className="mb-10 px-2 flex items-center justify-between">
              ...
              <Icons.Bell size={18} className="text-zinc-500 hover:text-white cursor-pointer transition-colors" />
            </div>

            {/* QUICK ACTIONS */}
            <div className="mb-8 flex gap-2">
              <Link href="/register" className="flex-1 bg-white text-black text-[10px] font-black uppercase py-3 rounded-xl text-center hover:bg-blue-600 hover:text-white transition-all">Sign In</Link>
            ...
            <div className="flex-1 space-y-1 overflow-y-auto pr-2 custom-scrollbar">
              ...
              <Link href="/crypto" className="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-white/5 font-bold text-sm transition-all group">
                <Icons.Coins size={18} className="group-hover:text-yellow-500" /> Cryptocurrency
              </Link>
              ...
              <Link href="/health" className="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-white/5 font-bold text-sm transition-all group">
                <Icons.Activity size={18} className="group-hover:text-rose-500" /> Health Hub
              </Link>
              ...
              <Link href="/map" className="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-white/5 font-bold text-sm transition-all group">
                <Icons.Navigation size={18} className="group-hover:text-blue-500" /> Logistics Radar
              </Link>
          ...
          <main className="flex-1 md:ml-72 bg-slate-950 relative min-h-screen overflow-x-hidden">
             ...
             <div className="p-10 pb-24 relative z-10 max-w-7xl mx-auto">
               {children}
             </div>
          </main>
        </div>
